...
\pagenumbering{roman}
\setcounter{page}{2}
\include{00_abstract/abstract} % #TODO: update!
\include{00_committee/committee}
\include{00_acknowledgments/acknowledgments} % #TODO: update!
...
\begin{refsection}[01_intro_chapter/intro_chapter.bib]
\include{01_intro_chapter/intro_chapter}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}

\begin{refsection}[02_abf_background/abf_background.bib]
\include{02_abf_background/abf_background}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}

\begin{refsection}[99_conclusion_chapter/conclusion_chapter.bib]
\include{99_conclusion_chapter/conclusion_chapter}
\cleardoublepage
\printbibliography[title={References}]
\end{refsection}
